...
class BedrockProvider extends AbstractLLMProvider
{
    ...
    public function getId(): string { return "bedrock"; }
    public function getName(): string { return "Amazon Bedrock"; }
    public function getModels(): array { return $this->availableModels; }
    protected function getDefaultModel(): string { return "anthropic.claude-3-haiku-20240307-v1:0"; }
