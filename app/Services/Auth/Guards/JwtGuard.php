...
class JwtGuard implements AuthGuardInterface {
    ...
    public function __construct(UserRepository $provider, Request $request, JWTService $jwtService) { $this->provider = $provider; $this->request = $request; $this->jwtService = $jwtService; }
    public function user(): ?User {
        ...
        try {
            ...
            if (isset($payload['sub'])) $this->user = $this->provider->find($payload['sub']);
