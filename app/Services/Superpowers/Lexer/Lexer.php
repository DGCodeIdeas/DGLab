...
class Lexer
{
    ...
    // Match any HTML tag with a reactive attribute: <button @click="...">
    private const PATTERN_REACTIVE_TAG = '/^<([a-zA-Z0-9]+)\s+[^>]*?@[a-zA-Z0-9]+=[^>]*?>/s';
    ...
    private function matchText(): void
    {
        ...
        // For reactive tags, we also look for any '<' followed by alphanumeric and then an '@' before '>'
        ...
        // Special check for reactive tags that might start with '<' but not '<s:'
