        ...
        <div class="row g-4">
            ...
            <div class="col-lg-2 col-md-6 offset-lg-1">
                ...
                <ul class="list-unstyled mb-0">
                    <li class="mb-2">
                        <a href="/services/epub-font-changer" class="text-muted text-decoration-none hover-white">EPUB Font Changer</a>
                    </li>
                    <li class="mb-2">
                        <a href="/services" class="text-muted text-decoration-none hover-white">All Services</a>
                    </li>
                    <li class="mb-2">
                        <a href="/api" class="text-muted text-decoration-none hover-white">API Access</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="col-lg-2 col-md-6">
                ...
                <ul class="list-unstyled mb-0">
                    <li class="mb-2">
                        <a href="/docs" class="text-muted text-decoration-none hover-white">Documentation</a>
                    </li>
                    <li class="mb-2">
                        <a href="/docs/api" class="text-muted text-decoration-none hover-white">API Reference</a>
                    </li>
                    <li class="mb-2">
                        <a href="/docs/adding-services" class="text-muted text-decoration-none hover-white">Add a Service</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <ul class="list-unstyled mb-0">
                    ...
                    <li class="mb-2">
                        <a href="/licenses" class="text-muted text-decoration-none hover-white">Licenses</a>
                    </li>
                </ul>
            </div>
        </div>
