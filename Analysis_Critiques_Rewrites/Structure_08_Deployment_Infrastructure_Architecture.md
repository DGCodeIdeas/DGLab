...
aws secretsmanager put-secret-value     --secret-id sovereign/${ENVIRONMENT}/database     --secret-string "{"password":"${NEW_DB_PASSWORD}","url":"mysql://user:${NEW_DB_PASSWORD}@db:3306/sovereign"}"
