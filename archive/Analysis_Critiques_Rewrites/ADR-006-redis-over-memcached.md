...
- Related blueprints: CORE-15 (Cache Abstraction — PSR-6/16 layer), HUB-02 (Sovereign Hub Cache), HUB-09 (Sovereign Pulse / Event Bus — Redis Pub/Sub), HUB-10 (Sovereign Queue — Redis Streams), HUB-07 (Rate Limiter — Redis atomic counters)
