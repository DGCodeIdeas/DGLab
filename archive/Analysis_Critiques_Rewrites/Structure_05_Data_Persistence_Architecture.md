...
```sql
-- Category 1: Tenant-Scoped (isolated per tenant)
CREATE TABLE users (
...
-- Category 3: Audit (append-only, no tenant isolation for super_admin visibility)
CREATE TABLE audit_log (
    id BIGINT PRIMARY KEY AUTO_INCREMENT,
    seq INT NOT NULL,
    tenant_id CHAR(26) NULL, -- NULL for system-level actions
