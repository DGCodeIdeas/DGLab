...
| [`CrossCutting/`](./CrossCutting) | Structure (Wheel, Pulse, Security, Events, Persistence, Boot, Testing, Deployment, Performance), Observability, Glossary, Threat Model, **[Nuclear-Grade Engineering Doctrine](./CrossCutting/NUCLEAR-GRADE-DOCTRINE.md)** (binding on Core tier — Step 5 packages CORE-19/15/14/16 since 2026-09-20; CORE-18 Kernel pilot added 2026-09-23; remaining Core packages bound in principle, per-package application sections landing incrementally per doctrine §11) |
